...
- **Algorithme CVL évolué** : calcul dynamique CVL/CCL/DCL multi-états avec hystérésis, mode Sustain et protection cellule sensible au courant (`src/cvl_logic.cpp`, `src/bridge_cvl.cpp`).
